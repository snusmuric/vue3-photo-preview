(function (global, factory) {
  ...
  var script$2 = vue.defineComponent({
      ...
      methods: {
          ...
          handleTouchMove: function (touchType, clientX, clientY, edgeTypes) {
              if (touchType === exports.TouchTypeEnum.Scale) {
          ...
          handleTouchScaleEnd: function (clientX, edgeTypes) {
              ...
              if (offsetX < -minSwitchImageOffset &&
                  edgeTypes.includes(exports.EdgeTypeEnum.Right)) {
                  this.handleNext();
              }
              // 上一张
              if (offsetX > minSwitchImageOffset &&
                  edgeTypes.includes(exports.EdgeTypeEnum.Left)) {
                  this.handlePrevious();
              }
          },
  ...
  function render$2(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_filp_vertical = vue.resolveComponent("filp-vertical");
    ...
    return (vue.openBlock(), vue.createBlock(vue.Teleport, { to: _ctx.teleportTo }, [
      (_ctx.photoVisible)
        ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 0,
          ...
          PhotoSlider__Hide: !_ctx.overlayVisible,
            ...
            vue.createElementVNode("div", _hoisted_1, [
              ...
              vue.createElementVNode("div", _hoisted_3, [
                ...
                vue.createVNode(_component_filp_vertical, {
                  class: "PhotoSlider__BannerIcon",
            ...
            -(_ctx.innerWidth + _ctx.horizontalOffset) * _ctx.index + _ctx.touchMoveX
                ...
                vue.createVNode(_component_photo_view, {
                  ...
                  src: item.src,
                  onClick: vue.withModifiers(_ctx.handleClickPhoto, ["stop"]),
